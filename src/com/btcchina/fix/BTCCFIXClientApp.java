...
public class BTCCFIXClientApp  implements quickfix.Application {
	...
	public void fromApp(quickfix.Message msg, SessionID sessionID)
   	 ...
   	 if (!msg.getHeader().getString(35).equals("X")) {
   		 return;
	 }
		//log.info("receivedType:"+msg.getHeader().getString(35));
...
//				}
				/*
				String ACCESS_KEY = "19283d8d-739f-4a45-94c2-b7a4ce699b81";
			    String SECRET_KEY = "cef048de-2425-4abe-84d8-fb630f70e711";
...
//				    message = tradeRequest.createNewOrderSingle(ACCESS_KEY, SECRET_KEY, Side.SELL, OrdType.LIMIT, 1001.1, 2.1, "BTCCNY"); //
				    message = tradeRequest.createNewOrderSingle(ACCESS_KEY, SECRET_KEY, Side.BUY, OrdType.LIMIT, 1994, 0.0001, "BTCCNY"); //

				    Session.lookupSession(sessionID).send(message);
				    
				    message = tradeRequest.createNewOrderSingle(ACCESS_KEY, SECRET_KEY, Side.SELL, OrdType.LIMIT, 1995, 0.0001, "BTCCNY"); //
